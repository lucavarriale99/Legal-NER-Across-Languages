...
def main() -> None:
    ...
    de_datasets_to_map = ["../../german/de_train.json", "../../german/de_validation.json"]
    ...
    en_datasets_to_map = ["../../english/en_train.json", "../../english/en_val.json"]
    ...
    es_datasets_to_map = ["../../spanish/spanish_train.json", "../../spanish/spanish_valid.json"]
