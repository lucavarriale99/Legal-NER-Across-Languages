...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--resume_checkpoint",
        help="Boolean flag, set true to resume from a checkpoint",
        default=False,
        const=True,
        nargs="?",
        required=False,
    ...
    resume_checpoint = args.resume_checkpoint 
    original_label_list = args.label_list
    model_paths = args.model_list
